...
class AboutDialog(QDialog):
    def __init__(self, parent=None, language_manager=None):
        ...
        self.setWindowTitle(self.language_manager.tr("about.title", "About Nidec Commander CDE"))
        ...
        description = QLabel(
            self.language_manager.tr(
                "about.description",
                "A tool to connect and parametrize the CDE Nidec Commander.\n\n"                
            )
        )
        ...
        github_btn.clicked.connect(lambda: QDesktopServices.openUrl(
            QUrl("https://github.com/Nsfr750/Nidec_CommanderCDE")))
