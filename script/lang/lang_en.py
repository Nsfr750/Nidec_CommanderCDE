...
TRANSLATIONS = {
        ...
        'simulator_control': 'Control',
        'simulator_start': 'START',
        'simulator_stop': 'STOP',
        'simulator_reset': 'RESET',
        'simulator_direction': 'Direction',
        'simulator_forward': 'FORWARD',
        'simulator_reverse': 'REVERSE',
        'simulator_parameters': 'Parameters',
        'simulator_connection': 'Connection',
        'simulator_connect': 'Connect',
        'simulator_disconnect': 'Disconnect',
        'simulator_port': 'Port',
        'simulator_baudrate': 'Baud Rate',
        'simulator_status': 'Status',
        'simulator_connected': 'Connected',
        'simulator_disconnected': 'Disconnected',
        'simulator_connection_error': 'Connection Error',
        'simulator_not_found': 'Simulator not found at: {}',
        'simulator_already_running': 'The simulator is already running',
        'simulator_crashed': 'The simulator has crashed or was closed with an error. Exit code: {}',
        'simulator_error': 'Simulator error: {}',
        'error_launching_simulator': 'Error launching simulator: {}',
        'close': 'Close',
        'copy': 'Copy',
        'paste': 'Paste',
        'cut': 'Cut',
