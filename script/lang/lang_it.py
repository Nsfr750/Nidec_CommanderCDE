...
TRANSLATIONS = {
    ...
    # Simulator
    'open_simulator': 'Apri Simulatore',
    'simulator_control': 'Controllo',
    'simulator_start': 'AVVIA',
    'simulator_stop': 'FERMA',
    'simulator_reset': 'RESET',
    'simulator_direction': 'Direzione',
    'simulator_forward': 'AVANTI',
    'simulator_reverse': 'INDIETRO',
    'simulator_parameters': 'Parametri',
    'simulator_connection': 'Connessione',
    'simulator_connect': 'Connetti',
    'simulator_disconnect': 'Disconnetti',
    'simulator_port': 'Porta',
    'simulator_baudrate': 'Velocità',
    'simulator_status': 'Stato',
    'simulator_connected': 'Connesso',
    'simulator_disconnected': 'Disconnesso',
    'simulator_connection_error': 'Errore di Connessione',
    'simulator_not_found': 'Simulatore non trovato in: {}',
    'simulator_already_running': 'Il simulatore è già in esecuzione',
    'simulator_crashed': 'Il simulatore si è bloccato o è stato chiuso con un errore. Codice di uscita: {}',
    'simulator_error': 'Errore del simulatore: {}',
    'error_launching_simulator': "Errore nell'avvio del simulatore: {}",
    'exit': 'Esci',
    'close': 'Chiudi',
    'copy': 'Copia',
    'paste': 'Incolla',
